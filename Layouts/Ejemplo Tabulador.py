...
from PySide6.QtWidgets import QWidget, QMainWindow, QApplication, QVBoxLayout, QHBoxLayout, QStackedLayout, QPushButton
...
class VentanaPrincipal(QMainWindow):
    def __init__(self):
        ...
        # Conectamos al evento Pressed del boton respectivo
    ...
    # def activar_boton_rojo(self):
    #     self.layout_tipo_stack.setCurrentIndex(0)
    #
    # def activar_boton_azul(self):
    #     self.layout_tipo_stack.setCurrentIndex(1)
    #
    # def activar_boton_amarillo(self):
